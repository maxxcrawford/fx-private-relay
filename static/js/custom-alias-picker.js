...
(function() {
    ...
    const customAliasPicker = {
        init: () => {
            const triggerButton = document.querySelector(".js-dash-create-new-domain-dialog-trigger");
            if (triggerButton) {
        ...
        //         const domainCanBeRegistered = await customAliasPicker.checkIfDomainIsSafeAndAvailable(requestedDomain);               
        ...
        //             customAliasPicker.modal.open(e.target);
        //         } else {
        ...
        //             customAliasPicker.showError(requestedDomain);
        //         }
        //     }
        // },
        modal: {
            ...
            open: (triggeringClickEvent) => {
                ...
                modalConfirmCheckbox.addEventListener("change", customAliasPicker.canModalBeSubmitted, false);
            ...
            formSubmitRequest: async (e) => {
                ...
                e.target.parentFormHTMLElement.removeEventListener("submit", customAliasPicker.events.onSubmit, false);  
                ...
                switch (e.target.parentFormHTMLElement.id) {
                    case "domainRegistration":
                        customAliasPicker.modal.showSuccessState(e.target.parentFormRequestedDomain,{ "form": "dashboard" });
                        break;
                    case "onboardingDomainRegistration":
                        customAliasPicker.modal.showSuccessState(e.target.parentFormRequestedDomain, { "form": "onboarding" });
                        break;
                }
                
            },
            showSuccessState: (domain, {form})=> {
                const modalRegistrationForm = document.querySelector(".js-custom-alias-picker-form");
                ...
                if (form === "onboarding") {
                    modalContinue.addEventListener("click", customAliasPicker.modal.close, false);
